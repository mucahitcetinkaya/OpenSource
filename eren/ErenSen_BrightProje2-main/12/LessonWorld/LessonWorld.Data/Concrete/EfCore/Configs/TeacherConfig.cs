...
namespace LessonWorld.Data.Concrete.EfCore.Configs
{
    public class TeacherConfig : IEntityTypeConfiguration<Teacher>
    {
        public void Configure(EntityTypeBuilder<Teacher> builder)
        {
            ...
            builder.HasOne(x => x.School).WithMany(x => x.Teachers).HasForeignKey(x => x.SchoolId).OnDelete(DeleteBehavior.SetNull);

            builder.HasOne(x => x.Lesson).WithMany(x => x.Teachers).HasForeignKey(x => x.LessonId).OnDelete(DeleteBehavior.SetNull);
