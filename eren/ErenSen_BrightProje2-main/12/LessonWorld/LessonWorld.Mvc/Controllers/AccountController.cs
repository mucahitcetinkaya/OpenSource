...
using LessonWorld.Mvc.Extensions;
...
namespace LessonWorld.Mvc.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            var subject = "LessonWorld Şifre Sıfırlama";
            var body = $"<h1>LessonWorld Şifre Sıfırlama İşlemi</h1>" +
                $"<p>" +
                $"Lütfen şifrenizi değiştirmek için <a href='http://localhost:5047{url}'>tıklayınız</a>." +
                $"</p>";
