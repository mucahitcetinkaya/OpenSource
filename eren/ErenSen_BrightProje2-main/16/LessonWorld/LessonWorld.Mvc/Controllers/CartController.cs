...
namespace LessonWorld.Mvc.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> DeleteItemFromCart(int id)
        {
            ...
            _notyf.Success("Ders sepetinizden silindi");
            return RedirectToAction("Index");
        }
        ...
        private Payment PaymentProcess(OrderViewModel model)
        {
            ...
            options.ApiKey = "sandbox-el3Y4bX0UgTdJL4H41q9DcimHc2ntMOb";
            options.SecretKey = "sandbox-5sE6fDvjW52DzAt7OfoDMYXd4wTTYoIA";
